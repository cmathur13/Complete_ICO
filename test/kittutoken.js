...
contract('kittuToken', function(accounts) {
  var tokenInstance;
  ...
  it('initializes the contract with the correct values', function() {
    return kittuToken.deployed().then(function(instance) {
      ...
      assert.equal(name, 'Kittu', 'has the correct name');
      return tokenInstance.symbol();
    }).then(function(symbol) {
      assert.equal(symbol, 'KIT', 'has the correct symbol');
    })
  })
  ...
  it('allocates the initial supply upon deployment', function() {
    return kittuToken.deployed().then(function(instance) {
      ...
      assert.equal(totalSupply.toNumber(), 100000, 'sets the total supply to 1,00,000');
